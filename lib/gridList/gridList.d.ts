...
export declare class GridList {
     ...
     */
    toString(): string;
    setOption(name: keyof IGridsterOptions, value: any): void;
    /**
    ...
    findDefaultPositionHorizontal(width: number, height: number): number[];
    findDefaultPositionVertical(width: number, height: number): number[];
    ...
    findItemByPosition(x: number, y: number): GridListItem;
    getItemByAttribute(key: keyof GridListItem, value: any): GridListItem;
    private padNumber;
    /**
